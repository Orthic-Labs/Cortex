...
export function findScipIndex(repoRoot, options = {}) {
  ...
  const candidates = explicit
    ...
    : [
        ...
        join(root, ".blueprint", "index.scip.json"),
      ];
...
export function probeScip(repoRoot, options = {}) {
  ...
  if (!indexPath) {
    return {
      ...
      state: "unavailable",
      reason: "no SCIP index found (set BLUEPRINT_SCIP_INDEX, or place index.scip.json / .blueprint/index.scip.json at repo root)",

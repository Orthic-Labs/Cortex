...
// ("upgrade to Node >=22.13"). The capability record is also emitted as a
...
export const RUNTIME_CAPABILITIES = Object.freeze({
  ...
  capabilities: Object.freeze({
    nodeSqlite: SUPPORTED, // `node:sqlite` ships in 22.5+; floor is 22.13.
...
export function checkRuntime() {
  ...
  return {
    ...
    error: {
      ...
      nodeVersion: NODE_VERSION,
      supportedRange: SUPPORTED_RANGE,
      remediation: "install Node >=22.13 (Node 22 LTS or 24+ recommended) and re-run the same command",
    },
  };
}

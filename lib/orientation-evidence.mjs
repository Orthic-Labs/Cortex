// Beacon-consumable orientation evidence — typed blob derived from receipts.
//
// Blueprint emits evidence; Beacon/Tether attests and gates signoff. This module
// does not enforce signoff — it only shapes the record Beacon can consume.
...
/**
 * Build a Beacon/Tether-compatible evidence record from an orientation receipt.
 *
...
/**
 * Write evidence to a file Beacon can attest (atomic replace).

// Sentinel-consumable orientation evidence — typed blob derived from receipts.
//
// Cortex emits evidence; Sentinel attests and gates signoff. This module
// does not enforce signoff — it only shapes the record Sentinel can consume.
...
/**
 * Build a Sentinel-compatible evidence record from an orientation receipt.
 *
...
/**
 * Write evidence to a file Sentinel can attest (atomic replace).
